...
describe('Calendar', () => {
  ...
  describe('onPanelChange', () => {
    it('trigger when click last month of date', () => {
      ...
      const wrapper = mount(
        <Calendar onPanelChange={onPanelChange} value={date} />,
      );
  ...
  it('dateFullCellRender', () => {
    const wrapper = mount(
      <Calendar
        dateFullCellRender={() => <div className="light">Bamboo</div>}
      />,
    );
    expect(
      wrapper
  ...
  it('monthFullCellRender', () => {
    const wrapper = mount(
      <Calendar
        mode="year"
        monthFullCellRender={() => <div className="bamboo">Light</div>}
      />,
    );
    expect(
      wrapper
