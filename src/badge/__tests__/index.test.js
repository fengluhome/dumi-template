...
describe('Ribbon', () => {
  ...
  describe('placement', () => {
    it('works with `start` & `end` placement', () => {
      ...
      expect(wrapperStart.find('.ant-ribbon-placement-start').length).toEqual(
        1,
      );
  ...
  describe('color', () => {
    ...
    it('works with custom color', () => {
      ...
      expect(wrapperLeft.find('.ant-ribbon').prop('style').background).toEqual(
        '#888',
      );
      expect(
      ...
      expect(wrapperRight.find('.ant-ribbon').prop('style').background).toEqual(
        '#888',
      );
      expect(
